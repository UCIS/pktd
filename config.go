...
type config struct {
	...
	AddressBalances      bool          `long:"addressbalances" description:"Maintain a database of address balances, needed for vote computation"`
	DropAddressBalances  bool          `long:"dropaddressbalances" description:"Delete the address balances table from the db on startup and then exits."`
	Votes                bool          `long:"votes" description:"Enable computation of Network Steward v2 votes, implies --addressbalances"`
	DropVotes            bool          `long:"dropvotes" description:"Delete the votes table and then exit."`
