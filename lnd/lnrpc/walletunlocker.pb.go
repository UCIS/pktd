...
const (
	SeedType_ST_LEGACY      SeedType = 0
	SeedType_ST_ENCRYPTED   SeedType = 1
	SeedType_ST_UNENCRYPTED SeedType = 2
)

// Enum value maps for SeedType.
var (
	SeedType_name = map[int32]string{
		0: "ST_LEGACY",
		1: "ST_ENCRYPTED",
		2: "ST_UNENCRYPTED",
	}
	SeedType_value = map[string]int32{
		"ST_LEGACY":      0,
		"ST_ENCRYPTED":   1,
		"ST_UNENCRYPTED": 2,
	}
...
func (x SeedType) Enum() *SeedType {
	p := new(SeedType)
	*p = x
	return p
}

func (x SeedType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SeedType) Descriptor() protoreflect.EnumDescriptor {
	return file_walletunlocker_proto_enumTypes[0].Descriptor()
}

func (SeedType) Type() protoreflect.EnumType {
	return &file_walletunlocker_proto_enumTypes[0]
}

func (x SeedType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SeedType.Descriptor instead.
func (SeedType) EnumDescriptor() ([]byte, []int) {
...
type CheckSeedResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SeedType SeedType `protobuf:"varint,1,opt,name=seed_type,json=seedType,proto3,enum=lnrpc.SeedType" json:"seed_type,omitempty"`
}

func (x *CheckSeedResponse) Reset() {
	*x = CheckSeedResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckSeedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckSeedResponse) ProtoMessage() {}

func (x *CheckSeedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_walletunlocker_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckSeedResponse.ProtoReflect.Descriptor instead.
func (*CheckSeedResponse) Descriptor() ([]byte, []int) {
	return file_walletunlocker_proto_rawDescGZIP(), []int{2}
}

func (x *CheckSeedResponse) GetSeedType() SeedType {
	if x != nil {
		return x.SeedType
	}
	return SeedType_ST_LEGACY
}

type CheckSeedRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SeedWords []string `protobuf:"bytes,1,rep,name=seed_words,json=seedWords,proto3" json:"seed_words,omitempty"`
}

func (x *CheckSeedRequest) Reset() {
	*x = CheckSeedRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckSeedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckSeedRequest) ProtoMessage() {}

func (x *CheckSeedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_walletunlocker_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckSeedRequest.ProtoReflect.Descriptor instead.
func (*CheckSeedRequest) Descriptor() ([]byte, []int) {
	return file_walletunlocker_proto_rawDescGZIP(), []int{3}
}

func (x *CheckSeedRequest) GetSeedWords() []string {
	if x != nil {
		return x.SeedWords
	}
	return nil
...
func (x *UnlockWalletRequest) GetWalletPubPassword() []byte {
	if x != nil {
		return x.WalletPubPassword
	}
	return nil
}
...
func (x *CreateWalletRequest) GetWalletPassword() []byte {
	if x != nil {
		return x.WalletPassword
	}
	return nil
...
func (x *CreateWalletRequest) GetCipherSeedMnemonic() []string {
	if x != nil {
		return x.CipherSeedMnemonic
	}
	return nil
...
func (x *CreateWalletRequest) GetAezeedPass() []byte {
	if x != nil {
		return x.AezeedPass
	}
	return nil
...
func (x *CreateWalletRequest) GetStatelessInitFlag() bool {
	if x != nil {
		return x.StatelessInitFlag
	}
	return false
}

func (x *CreateWalletRequest) GetSaveTo() string {
	if x != nil {
		return x.SaveTo
	}
	return ""
...
func (x *CreateWalletResponse) GetSeed() []string {
	if x != nil {
		return x.Seed
	}
	return nil
...
var file_walletunlocker_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x4d, 0x61, 0x63, 0x61, 0x72, 0x6f, 0x6f, 0x6e, 0x22, 0x82, 0x02,
	...
	,
	...
	0x74, 0x61, 0x74, 0x65, 0x6c, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x6e, 0x69, 0x74, 0x18, 0x05, 0x20,
	...
	0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xda, 0x01, 0x0a, 0x13, 0x43,
	...
	,
	...
	0x74, 0x64, 0x2f, 0x6c, 0x6e, 0x64, 0x2f, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_walletunlocker_proto_goTypes = []interface{}{
	(SeedType)(0),                // 0: lnrpc.SeedType
	(*GenSeedRequest)(nil),       // 1: lnrpc.GenSeedRequest
	(*GenSeedResponse)(nil),      // 2: lnrpc.GenSeedResponse
	(*CheckSeedResponse)(nil),    // 3: lnrpc.CheckSeedResponse
	(*CheckSeedRequest)(nil),     // 4: lnrpc.CheckSeedRequest
	(*InitWalletRequest)(nil),    // 5: lnrpc.InitWalletRequest
	(*InitWalletResponse)(nil),   // 6: lnrpc.InitWalletResponse
	(*UnlockWalletRequest)(nil),  // 7: lnrpc.UnlockWalletRequest
	(*UnlockWalletResponse)(nil), // 8: lnrpc.UnlockWalletResponse
	(*CreateWalletRequest)(nil),  // 9: lnrpc.CreateWalletRequest
	(*CreateWalletResponse)(nil), // 10: lnrpc.CreateWalletResponse
	(*ChanBackupSnapshot)(nil),   // 11: lnrpc.ChanBackupSnapshot
}
var file_walletunlocker_proto_depIdxs = []int32{
	0,  // 0: lnrpc.CheckSeedResponse.seed_type:type_name -> lnrpc.SeedType
	11, // 1: lnrpc.InitWalletRequest.channel_backups:type_name -> lnrpc.ChanBackupSnapshot
	11, // 2: lnrpc.UnlockWalletRequest.channel_backups:type_name -> lnrpc.ChanBackupSnapshot
	1,  // 3: lnrpc.WalletUnlocker.GenSeed:input_type -> lnrpc.GenSeedRequest
	5,  // 4: lnrpc.WalletUnlocker.InitWallet:input_type -> lnrpc.InitWalletRequest
	7,  // 5: lnrpc.WalletUnlocker.UnlockWallet:input_type -> lnrpc.UnlockWalletRequest
	9,  // 6: lnrpc.WalletUnlocker.CreateWallet:input_type -> lnrpc.CreateWalletRequest
	2,  // 7: lnrpc.WalletUnlocker.GenSeed:output_type -> lnrpc.GenSeedResponse
	6,  // 8: lnrpc.WalletUnlocker.InitWallet:output_type -> lnrpc.InitWalletResponse
	8,  // 9: lnrpc.WalletUnlocker.UnlockWallet:output_type -> lnrpc.UnlockWalletResponse
	10, // 10: lnrpc.WalletUnlocker.CreateWallet:output_type -> lnrpc.CreateWalletResponse
...
func file_walletunlocker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletunlocker_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckSeedResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
