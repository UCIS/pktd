...
type NsVote struct {
	...
	VoteForAddress          string `json:"vote_for_address"`
	VoterIsWillingCandidate bool   `json:"voter_is_willing_candidate"`
	InBlockNumber           int    `json:"in_block_number"`
}
type NsVotes struct {
	Votes   []NsVote `json:"votes"`
	HasMore bool     `json:"has_more"`
}
